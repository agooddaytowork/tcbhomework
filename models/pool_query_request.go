...
// ContextValidate validates this pool query request based on context it is used
func (m *PoolQueryRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
